...
# Method: Load urls from a text file
...
# Method: For loaded page, read the url (html)
...
# Method: Take the page content and then index and parse out the content of the page
